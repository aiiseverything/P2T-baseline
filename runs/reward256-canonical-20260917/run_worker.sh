...
TASK_CACHE="$(mktemp -d "/tmp/reward256-${TAG}.XXXXXX")"
...
export PYTHONPATH="$SUITE/source:$PROJECT/runs/arena-hard-v2-canonical-20260917/.arena-extra:$PROJECT/.vllm-extra"
