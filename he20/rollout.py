...
2. ``select_training_rollout`` -- a prompt group in which *every* response is
   ...
   dropped if it is still bad.  Training on such a group would also make the he20
   arm see a different prompt population than the sibling arms it is compared
   against.
